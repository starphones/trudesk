...
module.exports = function (middleware, router, controllers) {
  ...
  router.get('/api/v1/tickets/storenames', apiv1, canUser('tickets:view'), apiCtrl.tickets.getStoreNames)
  ...
  router.get('/api/v1/tickets/stats/agent/:timespan', apiv1, apiCtrl.tickets.getEmployeeOverview)
  router.get('/api/v1/tickets/stats/employee/:timespan', apiv1, apiCtrl.tickets.getEmployeeDirectoryOverview)
  router.get('/api/v1/tickets/stats/employee-directory/:timespan', apiv1, apiCtrl.tickets.getEmployeeDirectoryOverview)
